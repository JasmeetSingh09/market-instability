...
def main():
    ...
    print("  * DISCOVERY 1: spectral-topology coupling is regime-dependent (-0.09 calm ->")
    print("    -0.36 crisis).")
    print("  * DISCOVERY 2: crises do NOT share a common path through Fragility Space")
    print("    (heterogeneous classes of crises).")
